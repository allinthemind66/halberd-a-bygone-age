...
def world_tag
  puts "                                                                        "
  puts "                                                                        "
  sentence = "In a grim and perlious world the darkness consumes all. Brave adventurers stalk forgotten halls
...
def game_start
  puts "                                                                        "
  puts "                                                                        "
  "In the darkness you awaken. You find yourself in a strange place that is
  ...
  With your arms free you stand up and really look at your surroundings.".each_char do |c|
    print c
    sleep (0.05)
  end
  puts "\n"
  ...
  the closest parts of this room.".each_char do |c|
    print c
    sleep (0.05)
  end
  puts "\n"
  ...
  To the left on the western part of the room there is just an empty wall.".each_char do |c|
    print c
    sleep (0.05)
  end
  puts "                                                                        "
